...
<div id="mainnavbar">
  ...
  $pro=$tra->get_partidos1_ord();
  ?>
   <div id ="nuevo">
    <div style="width:300px; height:300px;" id= "nuevo2">
    </div>
    <div id="titulo">
    Fixture Torneo de Hockey de Huracan Categoria Cuarta
    </div>
    <?php $fecha = $pro[0]["fecha"];?>
     <div id="barra">
    Fecha <?php echo $pro[0]["fecha"];?> del Torneo de Hockey
    </div>
    <table class="table table-hover">
        <thead>
          <tr>
            <th >Hora</th>
            <th width="170px;">Local</th>
            <th >G</th>
            <th align="left" >vs</th>
            <th width="200px;">Visitante</th>
            <th >G</th>
          </tr>
        </thead>
         <tbody>
    ...
    { 
      if ($pro[$i]["fecha"]==$fecha)
      {
      ?> 
            <tr>
            <td><?php echo $pro[$i]["hora"];?></td>
            <td><?php echo $pro[$i]["local"];?></td>
            <td class="g"><?php echo $pro[$i]["goll"];?></td>
            <td>vs</td>
            <td><?php echo $pro[$i]["visitante"];?></td>
            <td class="g"><?php echo $pro[$i]["golv"];?></td>
            </tr>
             <?php }else {
              $fecha=$pro[$i]["fecha"];
               ?>
          ...
          <div style="position:relative;top:200px;" id="barra">
          Fecha <?php echo $pro[$i]["fecha"];?> del Torneo de Hockey
          </div>
          <table style="position:relative;top:200px;"class="table table-hover">
          <thead>
          <tr>
            <th >Hora</th>
            <th width="170px;">Local</th>
