...
if(isset($_POST["boton"]))
{
	...
	$sql="DELETE FROM `equipos3` WHERE 1";
	$res=mysql_query($sql, Conectar::con());
	//for ($k=1;$k<3;$k++) {
	for ($i=0;$i<sizeof($pro);$i++) {
	
	$valor=$pro[$i]['local'];
	$sql="INSERT INTO `equipos3`(`equipo`,`id`) VALUES ('$valor',$i)";
	$res=mysql_query($sql, Conectar::con());
		

	}//}
	$tra->cargar_puntos3($_POST['local'],$_POST['j'],$_POST['g'],$_POST['e'],$_POST['p'],$_POST['gf'],$_POST['gc'],$_POST['dif']);
}
?>
</body>
</html>