...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
      ...
      <link rel="stylesheet" type="text/css" media="screen" href="../Paginacorralon/css/grid_12.css">
      <link href='http://fonts.googleapis.com/css?family=Condiment' rel='stylesheet' type='text/css'>
      <link href='http://fonts.googleapis.com/css?family=Oxygen' rel='stylesheet' type='text/css'>
      <script src="../Paginacorralon/js/jquery-1.7.min.js"></script>
      <script src="../Paginacorralon/js/jquery.easing.1.3.js"></script>
...
<header>
   <div id="innerHeader">
   <h1 id="logo"><a href="/"><img src="images/CAH_logo2.png" alt="CAH"/></a></h1><!--Finlogo -->
   <div class="maintop">
