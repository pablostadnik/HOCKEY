...
<body>
		...
		<div class="container contenido">
			<h2>Editar partido Sexta categoria</h2>
		</div>
</body>
</html>
			...
			for ($i=0;$i<sizeof($pro);$i++){ ?>
				<tr valign="top" align="center">
					...
					<td valign="top" align="center" width="25">
						<a href="editar_partido2.php?id_partido=<?php echo $pro[$i]["id_partido"];?>&cat=sexta"><img src="images/editar.png"></img></a>
					</td>
				</tr>
			<?php 
			} 
